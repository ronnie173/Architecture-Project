...
public class DentalClaimProcessor extends AbstractProcedureProcessor implements MessageListener {
	...
	public void onMessage(Message message) {
		...
		try {
			...
			if (validatePolicy(claimFolder)
					&& this.validateProcedure(claimFolder,	ProcedureCategory.Dental)) {		
