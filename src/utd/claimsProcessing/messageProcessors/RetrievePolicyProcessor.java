...
/**
 * A message processor responsible for retrieving the Policy identified by the
 * Claim from the PolicyDAO. The retrieved policy is attached to the ClaimFolder
 * before passing to the next step in the process.
 */

public class RetrievePolicyProcessor extends MessageProcessor implements
		MessageListener {
	private final static Logger logger = Logger
			.getLogger(RetrievePolicyProcessor.class);
